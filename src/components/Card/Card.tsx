      ...
      <div className='Container'>
        <div className='Card'>
          <div className='Content mt-3 md:mt-2 lg:mt-0 3xl:mt-2 w-full'>
            ...
            <div className='h-28 md:p-2 lg:w-72 lg:mt-3 biglg:w-full xl:-mt-1 xl:p-0 xl:h-32 xl:w-full 3xl:p-0 3xl:mt-0 3xl:w-full'>
            ...
            <motion.div
              ...
              animate={controls}
              className='flex flex-wrap justify-center space-y-7 w-96 ml-1 mt-20 md:w-56 md:mt-4 md:space-y-3 lg:w-72 lg:mt-12 xl:mt-4 biglg:w-full xl:w-96 3xl:mt-10 3xl:w-full'
            >
              <Label text={tituloLinguagens} size="text-small md:text-real-small lg:text-more-small xl:text-small xl:-mt-6 3xl:text-small 3xl:mb-2"/>
