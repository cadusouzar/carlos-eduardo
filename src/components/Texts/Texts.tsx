...
export const Texts = () => {
  ...
  return(
    <div className="text-center ml-5 mr-5 relative h-36 top-12 space-y-2 md:ml-0 md:mr-0 md:top-4 lg:top-10 xl:top-14 3xl:top-11">
      ...
      {terceiroTexto && <Text text="desenvolvedor full-stack e de interfaces para o usuário" size="text-very-small md:text-medium-small lg:text-medium-small xl:text-medium-small 3xl:text-large"/>}
    </div>
  )
}