...
export const Skills = () => {
  return(
    <>
      <NavTop variantIcon="mylogo" textLabel="Habilidades"/>
      <div className="flex flex-col justify-center md:flex-row mt-20 md:flex xl:mt-4 3xl:mt-4">
      ...
      <div className="flex justify-center mb-4 mt-6 space-x-4 lg:space-x-20 lg:mb-8 biglg:-mt-10 xl:-mt-10 3xl:-mt-12">
        <LinkTo to='/aboutme'>
